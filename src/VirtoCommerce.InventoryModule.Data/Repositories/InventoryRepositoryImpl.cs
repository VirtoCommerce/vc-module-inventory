...
public class InventoryRepositoryImpl(InventoryDbContext dbContext, IUnitOfWork unitOfWork = null)
    : DbContextRepositoryBase<InventoryDbContext>(dbContext, unitOfWork),
