...
namespace VirtoCommerce.InventoryModule.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InventoryInfo :  IEquatable<InventoryInfo>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InventoryInfo);
        }

        /// <summary>
        /// Returns true if InventoryInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of InventoryInfo to be compared</param>
        /// <returns>Boolean</returns>
